...
export const metadata: Metadata = {
  title: "DialedWeb - Professional Web Design Agency",
  description: "Transform your business with stunning, high-converting websites. Professional web design services that drive results and captivate your audience.",
  keywords: "web design, website development, responsive design, SEO optimization, e-commerce solutions, digital agency",
  ...
  openGraph: {
    title: "DialedWeb - Professional Web Design Agency",
    description: "Transform your business with stunning, high-converting websites that drive results.",
    siteName: "DialedWeb",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/8534173/pexels-photo-8534173.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "DialedWeb web design services"
      }
    ]
  },
  twitter: {
    ...
    title: "DialedWeb - Professional Web Design Agency",
    description: "Transform your business with stunning, high-converting websites that drive results.",
    images: ["https://images.pexels.com/photos/8534173/pexels-photo-8534173.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
